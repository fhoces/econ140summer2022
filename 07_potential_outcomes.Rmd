...
Y_{Khuzdar} - Y_{Maria} &= Y_{1,Khuzdar} -Y_{0,Maria}\\
 &= (Y_{1,Khuzdar} + Y_{0,Khuzdar}) + (Y_{0,Maria} - Y_{0,Khuzdar})\\
 &= (1) + (-2)\\
\end{align}
$$  
...
&=  \kappa + \color{#e64173}{\mathop{Avg}\left(\color{#9370DB}{y_{0,i}} \mid D_i = 1 \right)} - \color{#9370DB}{\mathop{Avg}\left( y_{0,i}\mid D_i =0 \right)}\\
