...
# Original Slides
This slides are a modified version of [Kyle Raze's slides](https://raw.githack.com/kyleraze/EC320_Econometrics/master/Lectures/02-Statistics_Review/02-Statistics_Review.html#34) from University of Oregon.  

Any potential error is my responsibility
...
- We now know what a random variable is. Notice that we have not talked about how likely or unlikely each of these values are, we have not talked about its proportions in the long run. 
...
- The mythical [Stat 110 team](https://projects.iq.harvard.edu/stat110/home) shows us how the concepts of Discrete Random Variables and Probability Distributions can be used in practice. 
  ...
  - How does the Binamial(10, 0.06) relates to that previous distribution?

---
# Probability Distribution/Density Functions 1/N
...
By Tim Stellmach - Own work using Inkscape and Open Office Draw software., Public Domain, https://commons.wikimedia.org/w/index.php?curid=1220091