...
- Watch this video from [Stat 110](). And answer the following questions:
...
P(T=1) = P(T=1|S=1)P(S=1) + P(T=1|S=0)P(S=0)\\
 = 0.95\times 0.01 + 0.05\times 0.95 = `r 0.95 * 0.01 + 0.05 * 0.99` 
\end{equation}
$$
Hence: 
$$
\begin{equation}
P(S=1|T=1) = \frac{0.95 \times 0.01}{`r 0.95 * 0.01 + 0.05 * 0.99`}
\end{equation}
$$
]
---
...
---
# Conditional Expectation: Activity 2 
...
- Discuss an intuition interpretation for the the variance of $Y$ in terms of conditionals of (Eve's Law)

- Where does the 1400 comes from? 

- (for those interested in the fool proof, see [here](https://youtu.be/gjBvCiRt8QA?t=1405))
