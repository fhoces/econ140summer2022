...
Given that we are interested in variables at the familiy leve $(f)$ and at the twin level $(i)$, the long equation for this setting: 
...
\end{equation}
$$
What this study assumes is that this other $(A_{if})$ are constant within a family (they don't vary between individual $i$ within family $f)$. Given this, we can look at the regression equation of each twin: 
...
- Measurement error in the regressor of interest (treatment variable) leads to attenuation bais (appendix in Ch6). 
...
- Exclusion: probably yes, as the report on education probably affects earnings throught education alone. 
...
- In the first half of the 20th century, child labor was commo
---
# Acknowledgments
