...
- We need $D$ to be independent of the potential outcomes $(Y_{0}$ and $Y_{1})$. 
...
.pull-left[
- Read results: show how increasing coverage increases expenses. Link back to definition of conditional expectations. 
- Explain how evidence shows that expenses went up, in a consistent way with our intuitions: cheaper healthcare led to more consumption of it, and response was bigger among outpatients than inpatient.
